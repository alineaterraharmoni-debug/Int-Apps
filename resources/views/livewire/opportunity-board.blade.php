<div>
    ...
    <div class="text-[11px] text-gray-400 mb-2 md:hidden">
    ...
    >
        @foreach ($stages as $key => $label)
            ...
            <div
                class="bg-gray-100 rounded-2xl p-3 min-h-[140px] shrink-0 w-[82vw] sm:w-[60vw] md:w-auto snap-start"
            ...
            >
                ...
                @forelse ($items as $opty)
                    ...
                    >
                        ...
                        <div class="text-xs text-gray-500 mb-2">{{ $opty->customer?->name ?? $opty->customer_name }}</div>
    ...
    @if ($showModal)
        <div class="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center sm:p-4 z-50" wire:click.self="closeModal">
            <div class="bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-xl max-h-[92vh] sm:max-h-[88vh] overflow-y-auto p-4 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            @if (! $showQuickAddCustomer)
                                <select wire:model="customer_id" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
                            ...
                            @else
                                <div class="flex gap-1.5">
                                    <input type="text" wire:model="new_customer_name" placeholder="Nama customer baru" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
                                ...
                                <button type="button" wire:click="$set('showQuickAddCustomer', false)" class="text-[11px] text-gray-400 mt-1">Batal</button>
                            @endif
